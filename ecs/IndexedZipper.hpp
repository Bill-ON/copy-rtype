...
namespace containers
{
     ...
     * It additionnaly return the index of the entity at
     * each iteration.
     * 
     * e.g:
     * ```cpp
     ...
     * 
     * for (auto &&[pos, vel] : containers::IndexedZipper(positions, velocities))
     * {
     *     pos.x += vel.x;
     *     pos.y += vel.y
     * }
    ...
    public:
        ...
        /**
         * @brief Construct a new Indexed Zipper object
         * 
         * @param idx The starting position of the Zipper
         * iterator.
         * @param cs The Components SparseArrays.
         */
        IndexedZipper(std::size_t idx, Containers &...cs)
        {
            _size = min_element(cs.size()...);
        ...
        iterator begin()
        {
            return iterator(_begin, _size, _idx);
        }
